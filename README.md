# Домашная работа 28 "Работа правами доступа пользователей"
## Цель домашней работы
Расширить функционал сайта, внедрив систему контроля доступа к данным,
добавив инструменты для наделения пользователей и групп пользователей
правами для взаимодействия с сайтом.
